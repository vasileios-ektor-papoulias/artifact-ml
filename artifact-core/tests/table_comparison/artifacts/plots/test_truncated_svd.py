...
@pytest.fixture
def hyperparams() -> TruncatedSVDPlotHyperparams:
    hyperparams = TruncatedSVDPlotHyperparams(use_categorical=True)
    return hyperparams
...
def test_compute(
    ...
    hyperparams: TruncatedSVDPlotHyperparams,
):
    fake_fig = Figure()
