...
@pytest.mark.parametrize(
    ...
    [
        ("dataset_small", TSNEHyperparams(use_categorical=True)),
        ("dataset_small", TSNEHyperparams(use_categorical=False)),
        ("dataset_large", TSNEHyperparams(use_categorical=True)),
        ("dataset_large", TSNEHyperparams(use_categorical=False)),
        ("dataset_mixed", TSNEHyperparams(use_categorical=True)),
        ("dataset_mixed", TSNEHyperparams(use_categorical=False)),
    ],
...
def test_project(
    ...
    patcher_pca = mocker.patch.object(
        target=TSNE, attribute="fit_transform", return_value=mock_projection
    )
