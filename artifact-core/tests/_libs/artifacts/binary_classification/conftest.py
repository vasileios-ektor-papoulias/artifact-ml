...
@pytest.fixture
def binary_data_perfect_small() -> BinaryDataTuple:
    id_to_is_pos: Dict[Hashable, bool] = {0: True, 1: False}
    id_to_pred_pos: Dict[Hashable, bool] = {0: True, 1: False}
    id_to_prob_pos: Dict[Hashable, float] = {0: 0.9, 1: 0.1}
    return id_to_is_pos, id_to_pred_pos, id_to_prob_pos


@pytest.fixture
def binary_data_mixed_equal() -> BinaryDataTuple:
    id_to_is_pos: Dict[Hashable, bool] = {0: True, 1: True, 2: False, 3: False}
    id_to_pred_pos: Dict[Hashable, bool] = {0: True, 1: False, 2: True, 3: False}
    id_to_prob_pos: Dict[Hashable, float] = {0: 0.9, 1: 0.3, 2: 0.7, 3: 0.1}
    return id_to_is_pos, id_to_pred_pos, id_to_prob_pos


@pytest.fixture
def binary_data_all_fn() -> BinaryDataTuple:
    id_to_is_pos: Dict[Hashable, bool] = {0: True, 1: True}
    id_to_pred_pos: Dict[Hashable, bool] = {0: False, 1: False}
    id_to_prob_pos: Dict[Hashable, float] = {0: 0.3, 1: 0.2}
    return id_to_is_pos, id_to_pred_pos, id_to_prob_pos


@pytest.fixture
def binary_data_all_fp() -> BinaryDataTuple:
    id_to_is_pos: Dict[Hashable, bool] = {0: False, 1: False}
    id_to_pred_pos: Dict[Hashable, bool] = {0: True, 1: True}
    id_to_prob_pos: Dict[Hashable, float] = {0: 0.8, 1: 0.7}
    return id_to_is_pos, id_to_pred_pos, id_to_prob_pos
