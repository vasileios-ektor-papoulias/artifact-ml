...
def sample_figures_factory():
    def _factory(num_figs: int) -> PlotCollection:
        figs = {}
...
def test_plot_combiner_factory(
    ...
    sample_figures_factory: Callable[..., PlotCollection],
    num_figs: int,
    n_cols: int,
    ...
    combined_fig = PlotCombiner.combine(plots=dict_plots, config=config)
