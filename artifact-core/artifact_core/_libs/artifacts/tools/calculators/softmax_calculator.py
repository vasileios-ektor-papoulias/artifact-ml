...
class SoftmaxCalculator:
    ...
    @classmethod
    def compute_probs_multiple(cls, id_to_logits: Dict[Hashable, Array]) -> Dict[Hashable, Array]:
        id_to_probs = {
    ...
    @classmethod
    def compute_logits_multiple(cls, id_to_probs: Dict[Hashable, Array]) -> Dict[Hashable, Array]:
        id_to_logits = {
