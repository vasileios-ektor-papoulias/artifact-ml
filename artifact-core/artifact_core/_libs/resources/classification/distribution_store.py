...
from artifact_core._libs.artifacts.tools.calculators.softmax_calculator import SoftmaxCalculator
from artifact_core._libs.resource_specs.classification.protocol import (
    CategoricalFeatureSpecProtocol,
)
from artifact_core._libs.resources.tools.entity_store import EntityStore, IdentifierType

CategoricalDistribution = Union[Sequence[float], Array]
...
class CategoricalDistributionStore(EntityStore[Array], Generic[CategoricalFeatureSpecProtocolTCov]):
    def __init__(
        self,
    ...
    @staticmethod
    def _normalize_distn_shape(arr_distn: CategoricalDistribution) -> Array:
    ...
    @staticmethod
    def _validate_distn_array(arr_distn: Array, n_categories: int) -> None:
