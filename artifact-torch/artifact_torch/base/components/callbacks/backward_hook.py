...
class BackwardHookScoreCallback(
    ScoreExportMixin,
...
class BackwardHookArrayCallback(
    ArrayExportMixin,
...
class BackwardHookPlotCallback(
    PlotExportMixin,
...
class BackwardHookScoreCollectionCallback(
    ScoreCollectionExportMixin,
...
class BackwardHookArrayCollectionCallback(
    ArrayCollectionExportMixin,
    BackwardHookCallback[
        ModelTContr,
        Dict[str, ndarray],
...
class BackwardHookPlotCollectionCallback(
    PlotCollectionExportMixin,
    BackwardHookCallback[
        ModelTContr,
        Dict[str, Figure],
